...
#Prepare yourself for far more for loops than ever should exist in an R script

#Input from Star Catcher and Fusion Catcher
star_input <- read_tsv("star_data.tsv")
catcher_input <- read_tsv("fusion_catcher_data.tsv")
...
write.table(output, "star_fusion_combo.tsv", sep="\t", row.names = FALSE)
